...
//////////////////////////////////////////////////////////////
// configuration
var API_PORT = 8018; //const WEB_SOCKET_URL = `ws://localhost:${API_PORT}`;

var WEB_SOCKET_URL = "ws://bsearchau.accziom.com:".concat(API_PORT);
var START_MESSAGE = 'Hello! Please input your business name.';
...
var webSocket = CreateWebSocket(WEB_SOCKET_URL);
...
function getCode(code) {
  select(code); //webSocket.send('$' + code);
}
...
function addMsg(type, msg) {
  var li = document.createElement('li'); // 1: bot / 2: user

  if (type == 1) {
    li.classList.add('computer-say');
    li.innerHTML = "<span class=\"sayman\">BOT</span><span class=\"computer say\">".concat(msg, "</span>");
  } else {
    li.classList.add('my-say');
    li.innerHTML = "<span class=\"computer say\">".concat(msg, "</span><span class=\"sayman\">Me</span>");
    pl.value = '';
  }
